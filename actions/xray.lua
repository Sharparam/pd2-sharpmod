...
local function TOGGLE()
    --Switch
    sm.xray.enabled = not sm.xray.enabled

    if not sm.xray.enabled then
        --Switch OFF
...
--gXrayToggle = function() return TOGGLE,sm.xray.enabled end
