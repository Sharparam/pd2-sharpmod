    ...
    local sm = {
        ...
        options = {
            ...
            waypoints = {
                ...
                gen_pku_cocaine_directional = true,
                ...
                hold_pull_switch_distance = false,
                hold_remove_tarp = false,
                hold_take_gas_can = true,
                ...
                iphone_answer = true,
                key = false,
                mcm_panicroom_keycard_2 = true,
                mex_pickup_meth_bag = true,
                mex_pickup_murky_uniforms = true,
                mex_red_door = false,
                mex_red_room_key = true,
                money_wrap = true,
                money_wrap_single_bundle = true,
                money_wrap_updating = true,
                money_wrap_updating_directional = true,
                muriatic_acid = true,
                open_door = false,
                open_from_inside = true,
                open_slash_close = false,
