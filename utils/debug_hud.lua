...
if not sm.debug_hud then
    ...
    local debug_hud = {}
    local DebugGui = DebugGui or class()
    ...
    function debug_hud:enable()
        ...
        if sm.options.debughud_draw_drama then
            managers.groupai:state():set_drama_draw_state(true)
        end
        if sm.options.debughud_draw_state then
            managers.groupai:state():set_debug_draw_state(true)
        end
        if sm.options.debughud_console then
